 ...
 *******************************************************************************/
package com.example.nwillis.colorjot.colorpicker;
...
public class ColorPickerPreference extends Preference{
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            int choicesResId = a.getResourceId(R.styleable.ColorPickerPreference_cal_choices,
                    R.array.note_color_choice_values);
            if (choicesResId > 0) {
    ...
    protected void onClick() {
        ...
        ColorPickerDialog colorcalendar = (ColorPickerDialog) ColorPickerDialog.newInstance(R.string.color_picker_default_title,
				mColorChoices, getValue(), mNumColumns, Utility.isTablet(getContext())? ColorPickerDialog.SIZE_LARGE : ColorPickerDialog.SIZE_SMALL);
